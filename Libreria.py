...
while True:
    ...
    if elecion == "1":
        if input('Desea registrar (l/r): ') == "l":
            ...
            precio_re = float(input('precio de la revisa: '))
            cantidad_re = 0.0
            cantidades_revisas.append(cantidad_re)
        ...
        if input('Que deseas Comprar (l / r): ') == "l":
            ...
            if nombre_libro in titulos:
                if input('Desea fisico o copis (f / c): ') == "f":
                    ...
                    print(
                        f"Se vendieron {cantidadw} copias del libro de {nombre_libro} en fisico. Total: {cantidadw * total}")
                    print('++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++')
                else:
                    ...
                    print('+++++++++++++++++++++++Total de Pagar+++++++++++++++++++++++++++++')
                    print(
                        f"Se vendieron  {cantidadw} copias del libro de {nombre_libro} digitales. Total: {cantidadw * total}")
                    print('++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++')

        else:
            nombre_libro = input('Nombre o revista del libro a comprar: ')
            if input('Desea fisico o copis (f / c): ') == "f":
                cantidadw = float(input('Cuantas copias fisicas necesita? : '))
                ...
                automento_de = precios[indice] * porcen
                total = precio + automento_de
                cantidades_revisas[indice] += cantidadw
                print('+++++++++++++++++++++++++++++++Total de Pagar+++++++++++++++++++++++++++++')
                print(
                    f"""Se vendieron  {cantidadw} copias de revistas de {nombre_libro} en fisico  . Total: {cantidadw * total}""")
                print('++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++')
            else:
                cantidadw = float(input('Cuantas copias digitales necesita? : '))
                indice = nombres.index(nombre_libro)
                ...
                print('+++++++++++++++++++++++++++++++Total de Pagar+++++++++++++++++++++++++++++')
                print(
                    f"""Se vendieron {cantidadw} copias de revistas de {nombre_libro} digitales. Total: {cantidadw * total}""")
                print('++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++')
        ...
        if input('Desea ver la informacion del los libros o revistas (l/r): ') == "l":
            ...
            if len(nombres) <= 0:
                print("|--------------------+----------+----------+----------|")
                print('|===========No Hay Resvistas Disponibles==============|')
                print("|--------------------+----------+----------+----------|")
                continue
            else:
                indices = 0
                ...
                while indices < len(nombres):
                    ...
                    precio_ree = precios_revista[indices]
                    cantidad = cantidades_revisas[indices]

                    importe = precio_ree * cantidad
                    print('|{:<20}|{:>10.2f}|{:>10.2f}|{:>10.2f}|'.format(
                        nombre, cantidad, precio_ree, importe))
                    print('+=============+===========+===========+==========+====')
                    totales += importe
                    indices += 1
